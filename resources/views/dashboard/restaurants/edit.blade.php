...
@section('content')   
<div class="container">
    <h1 class="text-center mb-3">店舗編集</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-6">
            <form method="POST" action="{{ route('dashboard.restaurants.update', $restaurant) }}" enctype="multipart/form-data">
                @csrf
                @method('patch')
                ...
                <div class="row">
                    <img src="{{ asset('storage/restaurants/'. $restaurant->image) }}" class="mb-3 w-100" id="restaurantImagePreview">
                </div>  
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7 row">
                        <div class="col-5">
                            <input type="number" class="form-control" id="opening_hour" name="opening_hour" value="{{ old('opening_hour', substr($restaurant->opening_time, 0, 2)) }}" max="23" min="0" required>
                        </div>
                        <div class="col-1 px-0"><span class="form-control-plaintext">時</span></div>
                        <div class="col-5">
                            <input type="number" class="form-control" id="opening_minute" name="opening_minute" value="{{ old('opening_minute', substr($restaurant->opening_time, 3, 2)) }}" max="59" min="0" required> 
                        </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7 row">
                        <div class="col-5">
                            <input type="number" class="form-control" id="closing_hour" name="closing_hour" value="{{ old('closing_hour', substr($restaurant->closing_time, 0, 2)) }}" max="23" min="0" required>
                        </div>
                        <div class="col-1 px-0"><span class="form-control-plaintext">時</span></div>
                        <div class="col-5">
                            <input type="number" class="form-control" id="closing_minute" name="closing_minute" value="{{ old('closing_minute', substr($restaurant->closing_time, 3, 2)) }}" max="59" min="0" required> 
                        </div>
                        <div class="col-1 px-0"><span class="form-control-plaintext">分</span></div>          
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7 row">
                        <div class="col-5">
                            <input type="number" class="form-control" id="lowest_price" name="lowest_price" value="{{ old('lowest_price', $restaurant->lowest_price) }}" required>
                        </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7 row">                       
                        <div class="col-5">
                            <input type="number" class="form-control" id="highest_price" name="highest_price" value="{{ old('highest_price', $restaurant->highest_price) }}" required>
                        </div>
                        <div class="col-1 px-0"><span class="form-control-plaintext">円</span></div>
                    </div>
                </div>                 
